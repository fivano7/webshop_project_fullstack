...
const ProductGrid = ({ product }) => {
  return (
    <Link className="category-product-item" href={`/products/${product._id}`}>
      <img
        src={`${process.env.NEXT_PUBLIC_API_URL}/uploads/${product.images[0] ? product.images[0] : "no-image.jpg"
          }`}
        alt="Product"
      />
